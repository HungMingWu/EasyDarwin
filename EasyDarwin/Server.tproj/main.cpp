...
int main(int argc, char * argv[]) 
{
    ...
    //printf("current open file limit =%"_U32BITARG_"\n", (uint32_t) rl.rlim_cur); //leopard returns  256
    //printf("current open file max =%"_U32BITARG_"\n", (uint32_t) rl.rlim_max);//leopard returns infinity (-1)
    ...
    //printf("current open file limit =%"_U32BITARG_"\n", (uint32_t) rl.rlim_cur);
    //printf("current open file max =%"_U32BITARG_"\n", (uint32_t) rl.rlim_max);
    ...
    uint32_t debugOptions = kRunServerDebug_Off;
